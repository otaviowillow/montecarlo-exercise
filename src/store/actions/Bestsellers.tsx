...
export const setTopGamesByPlatforms = (
  byPlatforms: INameAndValue[] | null
) => ({ type: BestsellersTypes.SET_TOP_GAMES_BY_PLATFORMS, byPlatforms });

export const setTopGameByPlatform = (byPlatform: IBestseller[] | null) => ({
  type: BestsellersTypes.SET_TOP_GAME_BY_PLATFORM,
  byPlatform
});

export const setTopGamesByDate = (byDate: INameAndValue[] | null) => ({
  type: BestsellersTypes.SET_TOP_GAMES_BY_DATE,
  byDate
});

export const setPlatform = (platform: string | null) => ({
  type: BestsellersTypes.SET_PLATFORM,
  platform
});
